...
function NavBar() {
  ...
  const cartItems = useSelector((state) => state.cart?.cartItems); // Adjust based on your Redux cart state structure
  useEffect(() => {
    let sum = 0;
  ...
  const getLinkClasses = (path) => {
    return location.pathname === path
      ? "py-3 px-3 text-blue-500 border-b-2 border-blue-500"
      : "py-3 px-3 text-gray-700 hover:text-gray-900";
  };
      ...
      >
        ...
        {currentUser ? (
          ...
          <>
            ...
            <Link
              to="/signup"
              className="w-fit my-4 mx-1 block py-1 px-2 text-sm bg-blue-500 text-white rounded hover:bg-blue-400 transition duration-300"
              onClick={toggleMobileMenu}
            >
              Sign Up
            </Link>
